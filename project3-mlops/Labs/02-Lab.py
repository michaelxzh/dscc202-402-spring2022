...
parameters = {'n_estimators': [10, 100, 1000, 500], 
              'max_depth': [1, 5, 10, 7]}
...
grid_rf_model.fit(X_train, y_train)
best_rf = grid_rf_model.best_estimator_
with mlflow.start_run(experiment_id = '1420468418824440', run_name= 'RF-Grid-Search') as run:
...
client.search_runs('1420468418824440')

# COMMAND ----------

runs = client.search_runs('1420468418824440', order_by=["attributes.start_time desc"], max_results=1)
runs[0].data.metrics
