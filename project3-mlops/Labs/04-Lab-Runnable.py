...
# MAGIC %md
# MAGIC # TODO
# MAGIC Read from the widgets to create 3 variables.  Be sure to cast the values to numeric types
# MAGIC - n_estimators = FILL_IN
# MAGIC - learning_rate = FILL_IN
# MAGIC - max_depth = FILL_IN
...
with mlflow.start_run() as run:
  ...
  # Log model
  model_path = "gradient-boosted-tree-model"
...
# MAGIC %md
# MAGIC # TODO
# MAGIC Report the model output path to the parent notebook
